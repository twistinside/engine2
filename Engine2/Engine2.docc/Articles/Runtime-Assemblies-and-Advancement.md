...
- the App constructs Solar System Game Content, injects it into one compile-time-selected nonfallible assembly behind `some PRuntimeAssembly`, renders that assembly directly, and handles any thrown generic construction attempt explicitly
