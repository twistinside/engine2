...
- ``PImageArtifactEncoder`` defines asynchronous artifact-transformation ownership without exposing execution details; ``ImageIOArtifactEncoder`` owns no mutable resource or Runtime lifecycle and performs awaited detached CPU work for JPEG and PNG
