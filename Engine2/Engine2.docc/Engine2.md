...
- ``StarSystemGenerator`` performs finite, deterministic Game Content construction and returns a validated, serializable physical system without starting a Runtime or mutating ECS state.
...
- a versioned core-accretion-lite star-system generator with named deterministic random domains, a conserved annular disk, bounded embryo accretion and migration, deterministic orbital clearing, atmosphere and zero-dimensional climate resolution, significant moon formation, orthogonal physical classifications, persistence provenance, and validated solid and hydrogen-helium ledgers
