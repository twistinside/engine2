...
- The App will own independent top-level runtimes connected by immutable boundary values.
...
- The current ``RenderFrame`` extraction path is the first implemented simulation-to-render snapshot boundary.
