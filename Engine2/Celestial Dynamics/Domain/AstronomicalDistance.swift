/// Nonnegative celestial distance stored in meters.
///
/// Generation and dynamics use this value for physical radii and orbital
/// scales. Named projections make the unit explicit at every calculation
/// boundary.
