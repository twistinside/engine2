...
struct MiningGameContent: PGameContent {
    let inputMappingConfiguration: InputMappingConfiguration = .miningGame
    let simulationBehavior: any PSimulationBehavior = MiningSimulationBehavior()
    let worldBuilder: any PWorldBuilder = MiningWorldBuilder()
