...
final class SimulationRuntime: SelectedEntitySource, SimulationAdvanceTarget, SimulationPresentationSource {
    ...
    private var worldBuilder: any WorldBuilder
    ...
    private var sessionID: SimulationSessionID
    ...
    func replaceWorldBuilder(_ worldBuilder: any WorldBuilder) {
        self.worldBuilder = worldBuilder
    }

    /// Replaces the builder and immediately begins a new session from its world.
    func replaceWorldBuilderAndRebuild(_ worldBuilder: any WorldBuilder, inputBaseline: InputSnapshot?) {
        self.worldBuilder = worldBuilder
