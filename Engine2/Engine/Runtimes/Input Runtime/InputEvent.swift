...
enum InputEvent: Sendable {
    case focusLost
    case mouseButtonDown(MouseButton, position: SIMD2<Float>, viewportSize: SIMD2<Float>)
    case mouseButtonUp(MouseButton, position: SIMD2<Float>, viewportSize: SIMD2<Float>)
    case mouseDragged(delta: SIMD2<Float>, position: SIMD2<Float>, viewportSize: SIMD2<Float>)
