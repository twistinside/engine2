...
/// coordinator-owned `MetalRenderer` and connects the real-time Input Runtime
/// through its narrow event sink. Rendering samples completed values instead
/// of reading live `World` state or directly calling the Simulation Runtime.
struct MetalSceneView: NSViewRepresentable {
    ...
    final class Coordinator {
        ...
        init(
            renderAssetCatalog: RenderAssetCatalog,
            presentationSource: any SimulationPresentationSource,
