...
struct USDRenderModel {
    ...
    /// this descriptor and the model shader compile one raw layout. The packaged
    /// sphere authors smooth outward normals alongside its explicit polygonal
    /// geometry. This descriptor preserves those normals without introducing an
    /// engine-wide generation policy.
