...
- `Engine2/Runtime Configuration/Agent/*.swift`
  ...
  - `AgentSessionReplayCache` retains inseparable request/response entries under the configured FIFO count and named image-byte budgets. Accepted high-water, in-flight work, and lifecycle remain independent coordinator state.
