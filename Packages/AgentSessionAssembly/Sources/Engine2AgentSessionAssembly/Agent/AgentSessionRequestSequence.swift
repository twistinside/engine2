...
/// were evicted.
public nonisolated struct AgentSessionRequestSequence: Codable, Hashable, RawRepresentable, Sendable {
    /// First request position accepted by a newly constructed session.
    public static let first = AgentSessionRequestSequence(rawValue: 0)
    ...
    public func successor() -> AgentSessionRequestSequence? {
