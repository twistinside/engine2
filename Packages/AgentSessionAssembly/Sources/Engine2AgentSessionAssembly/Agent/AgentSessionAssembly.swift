...
public struct AgentSessionAssembly: PRuntimeAssembly {
    public nonisolated let sessionID: AgentSessionID
    public nonisolated let initialCursor: SimulationCursor
    public nonisolated let firstRequestID: AgentSessionRequestID
    ...
    public nonisolated var target: any PAgentSessionTarget {
        coordinator
    }
    ...
    public nonisolated func stopAndDrain() async {
