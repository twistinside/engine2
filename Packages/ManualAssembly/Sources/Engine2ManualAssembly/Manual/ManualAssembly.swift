...
public struct ManualAssembly: PRuntimeAssembly {
    ...
    public nonisolated var advanceTarget: any PSimulationAdvanceTarget {
        simulationRuntime
    }

    /// Latest-value presentation capability for independently paced consumers.
    public var presentationSource: any PSimulationPresentationSource {
        simulationRuntime
    }
