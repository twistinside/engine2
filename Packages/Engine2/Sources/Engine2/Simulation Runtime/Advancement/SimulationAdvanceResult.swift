...
public nonisolated struct SimulationAdvanceResult: Equatable, Sendable {
    public let initialCursor: SimulationCursor
    public let finalCursor: SimulationCursor
    public let completedStepCount: SimulationCompletedStepCount
    public let finalPresentationSnapshot: SimulationPresentationSnapshot
