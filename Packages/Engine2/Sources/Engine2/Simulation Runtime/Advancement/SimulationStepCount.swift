...
public nonisolated struct SimulationStepCount: Hashable, RawRepresentable, Sendable {
    public static let one = SimulationStepCount(rawValue: 1)
    ...
    public init?(validating rawValue: UInt32) {
