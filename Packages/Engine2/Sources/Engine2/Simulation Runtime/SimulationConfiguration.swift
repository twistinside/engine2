...
nonisolated public struct SimulationConfiguration: Equatable, Sendable {
    public let pointerOrbitSensitivity: Float
    public let scrollZoomSensitivity: Float
    public let cameraOrbitTarget: SIMD3<Float>
    public let minimumCameraOrbitRadius: Float
    public let maximumCameraOrbitRadius: Float
