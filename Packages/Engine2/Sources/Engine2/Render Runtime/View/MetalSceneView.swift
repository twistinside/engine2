...
public struct MetalSceneView: NSViewRepresentable {
    private var renderAssetCatalog: RenderAssetCatalog
    private var presentationSource: any PSimulationPresentationSource
    private var inputSink: (any PInputEventSink)?
    private var outputMode: RenderOutputMode

    public init(
        renderAssetCatalog: RenderAssetCatalog,
        presentationSource: any PSimulationPresentationSource,
        inputSink: (any PInputEventSink)?,
    ...
    public func makeNSView(context: Context) -> InputMetalView {
    ...
    public func updateNSView(_ nsView: InputMetalView, context: Context) {
    ...
    public final class Coordinator {
        ...
        init(
            ...
            do {
                ...
                rendererAvailability = .available(renderer)
            } catch {
