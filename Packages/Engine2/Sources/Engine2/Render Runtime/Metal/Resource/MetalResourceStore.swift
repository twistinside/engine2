...
final class MetalResourceStore {
    ...
    private var models: [MeshAssetKey: USDRenderModel] = [:]
    ...
    private let materialDescriptions: [
        MaterialAssetKey: PBRMaterialDescription
    ]
    ...
    func model(for id: MeshAssetKey) -> USDRenderModel? {
        models[id]
    }
    ...
    func materialDescription(for id: MaterialAssetKey) -> PBRMaterialDescription {
