...
public nonisolated struct Camera: Sendable {
    ...
    public nonisolated enum Projection: Equatable, Sendable {
        ...
        public static let standardPerspective = Self.perspective(
    ...
    public static let standard = Camera(
    ...
    public init(position: SIMD3<Float>, rotation: simd_quatf, projection: Projection) {
