...
public nonisolated struct OffscreenRenderLimits: Equatable, Sendable {
    /// Conservative policy suitable for general-purpose callers.
    public static let conservative = OffscreenRenderLimits(
        maxDimension: 8_192,
    ...
    public init(maxDimension: Int, maxPixelCount: Int) {
    ...
    public func permits(_ size: RenderPixelSize) -> Bool {
