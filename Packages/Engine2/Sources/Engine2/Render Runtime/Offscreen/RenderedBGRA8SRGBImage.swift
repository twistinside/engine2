...
public nonisolated struct RenderedBGRA8SRGBImage: Equatable, Sendable {
    public let size: RenderPixelSize
    public let bytesPerRow: Int
    public let origin: RenderedImageOrigin
    public let bytes: Data

    /// Validates and adopts exactly one tightly packed image payload.
    public init(size: RenderPixelSize, bytes: Data) throws(RenderedBGRA8SRGBImageError) {
