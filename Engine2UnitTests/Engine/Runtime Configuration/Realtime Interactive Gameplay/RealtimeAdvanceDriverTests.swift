...
struct RealtimeAdvanceDriverTests {
    ...
    private func makeDriver(
        ...
        inputSource: (any InputSnapshotSource)?,
...
private extension RealtimeAdvanceDriverTests {
    ...
    nonisolated private final class TestRealtimeClock: RealtimeClock, @unchecked Sendable {
    ...
    private actor RecordingAdvanceTarget: SimulationAdvanceTarget {
    ...
    private actor SuspendedAdvanceTarget: SimulationAdvanceTarget {
    ...
    private final class SequencedInputSource: InputSnapshotSource {
    ...
    private final class NonmonotonicTestClock: RealtimeClock {
        typealias Wake = (
            instant: SuspendingClock.Instant,
            result: Result<Void, any Error>
        )
